...
{
    /// <inheritdoc />
    public partial class calosc : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Zawodnicy",
                columns: new[] { "ZawodnikId", "KlubId", "czyKontuzja", "imie", "kondycja", "nrKoszulki" },
                values: new object[,]
                {
                    { 3, null, false, "Wojciech", 8m, (byte)1 },
                    { 1, 1, false, "Robert", 9.5m, (byte)9 },
                    { 2, 2, true, "Kamil", 7m, (byte)15 }
                });
